...
<meta charset="UTF-8" />
<meta name="keywords"
	content="My Institution Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
<script>
	...
	<header>
		<div class="container">
			<div class="header py-4 px-sm-4 px-3">
				...
				<div id="logo">
					<h1>
						<a href="LandingPage.jsp">X-workz</a>
					</h1>
				</div>
				<!-- //logo -->
				<!-- nav -->
				...
				<form action="Upload.ams" method="post"	enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="col-form-label">Email</label> <input type="text"
							class="form-control" placeholder="xxx@gmail.com" name="email"
							required="">
					</div>

					<div class="form-group">
						<label class="col-form-label">Pin</label> <input type="text"
							class="form-control" placeholder="" name="pin" required="">
					</div>

					<div class="form-group">
						<label class="col-form-label">URL</label> <input type="text"
							class="form-control" placeholder="URL" name="url">
					</div>


					<div class="form-group">
						<label class="col-form-label">File</label> <input type="file"
							class="form-control" placeholder="" name="file">
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<p
					...
					2019 My Institution. All Rights Reserved</p>
				<!-- //copyright -->
