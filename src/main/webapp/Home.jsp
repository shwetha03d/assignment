    ...
    <header>
        <div class="container">
            <div class="header py-2 px-sm-2 px-1">
                <div id="logo">
                    <h1><a href="LandingPage.jsp">Assignment Management System</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
    ...
    <div class="main-w3pvt mian-content-wthree text-center" id="home">
        <div class="container">
            <div class="style-banner mx-auto">
                <h3 class="text-wh font-weight-bold">A best place <span>to manage</span> <br>Assignments</h3>
               <!--  <p class="mt-3 text-li" id="join">Join X-workz now</p> -->
                </div>
            </div>
        </div>
    </section>
